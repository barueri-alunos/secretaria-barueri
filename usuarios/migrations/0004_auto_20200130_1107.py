...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('data_da_avaliacao', models.DateField(max_length=10, verbose_name='Data de avalição')),
                ('nome_do_trabalhador', models.CharField(max_length=255)),
                ('telefone', models.CharField(max_length=15)),
                ('nome_da_empresa', models.CharField(max_length=100)),
                ('contracao', models.DateField(max_length=10)),
                ('cargo_funcao', models.CharField(max_length=255)),
            ],
            options={
